...
\par The increasingly high number of advances and applications of weak artificial intelligence make it important for us to consider the idea that we are working towards building intelligent agents that could become superintelligent some day. If the rate at which artificial intelligence has improved in the last decade continues, we will have to consider the implications of the future creation of artificial intelligence. This brings up the question, what are the impacts of creating strong artificial intelligence? Could it become a threat in the future as it becomes increasingly more intelligent?

\par In addition, if we were to instill a sense of morality in these thinking machines, then we have to consider the question of how we are going to extend moral behavior into thinking machines. If we are to make deliberations about the method we are to use to teach moral behavior or what constitutes moral behavior, how should we go about making these decisions? Researchers are currently studying the usage of fables in teachings of moral ethics to these intelligent agents.

\par Finally, it is necessary to explore the other factors that make us human, even if we do not immediately associate them with intelligence, e.g. conscience, desire, rationality, intuition, and common sense. How are each of these factors connected to intelligence? Are these a product of being intelligent or are they factors that determine how intelligent something is? This question is important and is one that is worth asking. The conclusion and discussion these questions produce should help make decisions about how we should design and teach these intelligent agents.
