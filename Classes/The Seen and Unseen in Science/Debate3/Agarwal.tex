...
% The picture or observation 
% Logically, the scientists also seem to have more data on dropping the bomb since they had to propose their findings and make a case for it to the president/senate/etc.
